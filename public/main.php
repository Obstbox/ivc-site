...
<head>
  <meta charset="UTF-8">
  <title>Веб-страница Информационно-вычислительного центра</title>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="two-thirds column" style="margin-top: 20%">          
          <ul>
            <li>Список <a href="index.php?current=computerTable">компьютеров</a></li>
        ...
        <ul>
          <li>Компьютеры - 127</li>          
          <li>Принтеры/МФУ - 42</li>
        </ul>  
        </div>
      </div>
